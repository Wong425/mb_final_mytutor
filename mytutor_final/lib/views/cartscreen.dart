...
class _CartScreenState extends State<CartScreen> {
                            ...
                            children: List.generate(cartList.length, (index) {
                              return InkWell(
                                ...
                                children: [
                                  ...
                                  Text(
                                    cartList[index].crname.toString(),
                                    style: const TextStyle(
                                        fontSize: 18,
  ...
  void _loadCart() {
    http.post(
        Uri.parse(CONSTANTS.server + "/279199/final_mbmytutor/php/load_cart.php"),
        body: {
      ...
      if (response.statusCode == 200 && jsondata['status'] == 'success') {
        ...
        if (extractdata['cart'] != null) {
          ...
          for (var element in cartList) {
            ...
            totalpayable =
                totalpayable + double.parse(element.cricetotal.toString());
          }
  ...
  void _deleteItem(int index) {
    http.post(
        Uri.parse(CONSTANTS.server + "/279199/final_mbmytutor/php/delete_cart.php"),
        body: {
          'customer_email': widget.customer.email,
  ...
  void _updateCart(int index, String s) {
    ...
    http.post(
        Uri.parse(CONSTANTS.server + "/279199/final_mbmytutor/php/update_cart.php"),
