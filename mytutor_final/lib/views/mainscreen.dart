...
class _MainScreenState extends State<MainScreen> {
                                        ...
                                        ? CachedNetworkImage(
                                          // C:\xampp\htdocs\final_mbmytutor\assets\subjects
                                            imageUrl: CONSTANTS.server +
                                                "/279199/final_mbmytutor/assets/subjects/" +
                                                courseList[index]
                                                    .courseId
                                                    .toString() +
                                                '.jpg',
  ...
  void _loadProducts(int pageno, String _search, String _type) {
    ...
    http.post(
        Uri.parse(CONSTANTS.server + "/279199/final_mbmytutor/php/load_subject.php"),
        body: {
              ...
              children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text("Course Description: \n" +
                      courseList[index].courseDescription.toString()),
                  Text("Price: RM " +
                      double.parse(courseList[index].coursePrice.toString())
                          .toStringAsFixed(2)),
                  Text("Quantity Available: " +
                      courseList[index].courseQty.toString() +
                      " units"),
                  Text("Course Rating: " +
                      courseList[index].courseRating.toString()),
                  // Text("Product Date: " +
  ...
  void _addtoCart(int index) {
    http.post(
        Uri.parse(CONSTANTS.server + "/279199/final_mbmytutor/php/insert_cart.php"),
        body: {
          "email": widget.customer.email.toString(),
          "crid": courseList[index].courseId.toString(),
        }).timeout(
      const Duration(seconds: 5),
      onTimeout: () {
        return http.Response(
